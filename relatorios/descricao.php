<?php  
  ...
  $data_pg = $_POST['data_inicio']; 
  $data_vc = $_POST['data_fim'];
      ...
      <div class="container-fluid">
        <h1 align="center" class="ls-title-intro ls-ico-stats"> Relatórios </h1>
         ...
         <?php  
          ...
          $query = "SELECT * FROM movimentacoes WHERE idUSUARIO = '$id_usuario' AND DATA_VENCIMENTO
                BETWEEN ('$data_pg') AND ('$data_vc') AND DESCRICAO LIKE '%".$descricao."%'";
        ...
        ?>     
         ...
         <li> <p class="ls-text-md"><b> Total de registros encontrados: </b> &nbsp;<span class="ls-color-info"> <?php echo $num_linhas ?>. </span></p></li>
                ...
                $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE DESCRICAO LIKE '%".$descricao."%' AND DATA_VENCIMENTO
             ...
             <li> <p class="ls-text-md"><b> valor Total de gastos com</b> <span class="ls-color-info"> <?php echo $descricao ?>
             </span>: <span style="color: green;"> &nbsp;<?php echo $soma_despeza ?> R$.</span> </p> </li>
