    ...
    <main class="ls-main ">
      <div class="container-fluid">
        <h1 align="center" class="ls-title-intro ls-ico-stats"> Relatórios </h1> 
          ...
          $query = "SELECT * FROM movimentacoes Where TIPO = '$tipo' AND idUSUARIO = '$id_usuario'";
        ...
        ?>     
          ...
          <p><b> Todos os  lançamentos feitos com: <?php if($tipo == 'Crédito'){ ?> 
                  </b> &nbsp; <span class="ls-color-info"><?php echo " cartão de $tipo";}
