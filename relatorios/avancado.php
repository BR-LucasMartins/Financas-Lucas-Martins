      ...
      <div class="container-fluid">
        <h1 align="center" class="ls-title-intro ls-ico-stats"> Relatórios </h1>
          ...
          $query = "SELECT * FROM movimentacoes WHERE idUSUARIO = '$id_usuario' AND DATA_VENCIMENTO
                BETWEEN ('$data_pg') AND ('$data_vc') AND TIPO = '$tipo' AND SITUACAO = '$situacao' AND
                CATEGORIA = '$categoria' ";
        ...
        ?>     
         ...
         <ul>
          ...
          <li><p class="ls-text-md"><b> Período:</b> &nbsp; <span class="ls-color-info"> <?php echo $data1; ?></span> &nbsp; à &nbsp;
                  <span class="ls-color-info"> <?php echo $data2; ?>.</span></p></li>

          <li> <p class="ls-text-md"><b> Categoria: </b> &nbsp;<span class="ls-color-info"> <?php echo $categoria ?>. </span></p>
          </li>

          <li> <p class="ls-text-md"><b> Situação do Pagamento das contas: </b> &nbsp;<span class="ls-color-info"> <?php echo $situacao ?>. </span></p>
          </li>

              <li> <p class="ls-text-md"><b> Tipo do Pagamento foi em : </b> &nbsp;<span class="ls-color-info"> <?php echo $tipo ?>. </span></p>
          </li>
