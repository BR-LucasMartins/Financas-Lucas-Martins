    ...
    <main class="ls-main ">
      <div class="container-fluid">
        <h1 align="center" class="ls-title-intro ls-ico-stats"> Relatórios </h1>
          ...
          $query = "SELECT * FROM movimentacoes Where SITUACAO= '$situacao' AND LANCAMENTO = 'Despeza' AND 
        ...
        ?>     
          ...
          <p><b> Todos os  lançamentos em situação:
            <?php if($situacao == 'Pago'){ ?>

              &nbsp; <span style="color: green;"> <?php echo $situacao; ?> . </span> </p> <?php }

              else { ?>

                  &nbsp; <span style="color: red;"> <?php echo $situacao; ?> . </span> </p> <?php } ?>
             
          </b>
          <p><b> Total de registros encontrados: </b> &nbsp;<span class="ls-color-info"> <?php echo $num_linhas ?> </span> </p>
              ...
              <?php  
                ...
                $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE SITUACAO = '$situacao' AND idUSUARIO = '$id_usuario' ";
                $total = mysqli_query($conexao, $query);

                while ($linha = mysqli_fetch_array($total))
                {
                  $soma = number_format($linha['total'], 2,'.',''); 
                }
              ...
              <p><b> valor Total das contas Pendentes: </b> <span class="ls-color-info" > &nbsp;<?php echo $soma; ?> R$.</span> </p>
              ...
              <style type="text/css"> #imprimir{width: 100px;}</style>
                ...
                <table class="ls-table ls-bg-header ls-table-striped ls-table-bordered">
                  <thead>
                    <tr>
                      <th width="150px;" class="ls-txt-center">Descrição </th>
