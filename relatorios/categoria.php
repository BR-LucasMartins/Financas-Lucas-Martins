    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <?php  
          ...
          $query = "SELECT * FROM movimentacoes Where CATEGORIA = '$categoria' AND idUSUARIO = '$id_usuario'";
        ...
        ?>     
          ...
          <p><b> Todos os  lançamentos referente à categoria:</b> &nbsp; <span class="ls-color-info"> <?php echo $categoria; ?> . </span> </p>
          <p><b> Total de registros encontrados: </b> &nbsp;<span class="ls-color-info"> <?php echo $num_linhas ?> </span> </p>

              <?php  

                $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE CATEGORIA = '$categoria' AND idUSUARIO = '$id_usuario' ";
              ...
              <p><b> valor Total dos registros: </b> <span class="ls-color-info" > &nbsp;<?php echo $soma; ?> R$.</span> </p>
