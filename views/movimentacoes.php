...
$num_paginas = ceil($num_linhas/$itens_por_pagina);   // total de paginas 
      ...
      <div class="container-fluid">
        <h1 align="center" class="ls-title-intro ls-ico-hours"> Movimentações </h1>
            ...
            <table class="ls-table ls-no-hover ">
              <tr>
                <td width="600px;">
                  <form action="../filtros/filtro_periodo.php" method="post" class="ls-form ls-form-inline">
            ...
            <div align="right">
                ...
                <a href="#" id="tipo" class="ls-btn" data-ls-module="modal" data-target="#filtroTipo"> <b class="ls-color-success"> Filtrar por Tipo </b> </a> <style> #tipo{width: 250px;}</style>&nbsp;&nbsp;
               
                <a href="#" id="situacao" class="ls-btn" data-ls-module="modal" data-target="#filtroSituacao"> <b class="ls-color-success"> Filtrar por Situação </b> </a> <style> #situacao{width: 250px;}</style>&nbsp;&nbsp;
                 
              <a id="nova_movimentacao" class="ls-btn-primary-danger " href="novaMovimentacao.php"> adc Nova Movimentação</a>
               <style> #nova_movimentacao{width: 200px;}</style> 
            </div>    
  <br>
                

<div>
  <a id="recarregar" href="movimentacoes.php" title="Recarregar" class="ls-btn ls-ico-spinner ls-float-right">
            </a>
  ...
  <ul class="ls-dropdown-nav">
       <li><a href="../2019/janeiro.php">Janeiro</a></li>
        <li><a href="../2019/fevereiro.php">Fevereiro</a></li>
        <li><a href="../2019/marco.php">Março</a></li>
        <li><a href="../2019/abril.php">Abril</a></li>
        <li><a href="../2019/maio.php">Maio</a></li>
        <li><a href="../2019/junho.php">Junho</a></li>
        <li><a href="../2019/julho.php">Julho</a></li>
        <li><a href="../2019/agosto.php">Agosto</a></li>
        <li><a href="../2019/setembro.php">Setembro</a></li>
        <li><a href="../2019/outubro.php">Outubro</a></li>
        <li><a href="../2019/novembro.php">Novembro</a></li>
        <li><a href="../2019/dezembro.php">Dezembro</a></li>
  </ul>  
</div>
  <div data-ls-module="dropdown" class="ls-dropdown">
...
<!-- Modal do filtro situacao -->
  ...
  <form action="../filtros/filtro_situacao.php" class="ls-form" method="post">
    <div class="ls-modal-small">
      <div class="ls-modal-header">
        <button data-dismiss="modal">×</button>
        <h4 style="color: #FF7F00;"  class="ls-modal-title"> Filtrar por Situação </h4>
      </div>
...
<div class="ls-modal" id="filtroTipo">
  <form action="../filtros/filtro_tipo.php" class="ls-form" method="post">
    <div class="ls-modal-small">
      <div class="ls-modal-header">
        <button data-dismiss="modal">×</button>
...
<!-- ########################################################################################################## -->
        ...
        <div>       
                  ...
                  <thead>
                    <tr>
                      <th width="200px;" class="ls-txt-center">Descrição </th>
                      <th class="ls-txt-center" >Valor</th>
                      <th width="200px;" class="ls-txt-center">Categoria</th>
              ...
              <?php  
                ...
                $query = "SELECT * FROM movimentacoes WHERE idUSUARIO = '$id_usuario' AND DESCRICAO LIKE '%".$palavra."%'  ORDER By idFINANCAS DESC LIMIT $inicio, $itens_por_pagina";
        ...
        <ul class="ls-pagination">
          <li>
              <?php 
                if($anterior >= 0)
                { ?>
                  <a href="movimentacoes.php?pagina=<?php echo $anterior; ?>">&laquo; Anterior</a></li>  
                <?php 
                }
          ...
          <?php  
            for($i=$inicio; $i<= $limite; $i++){  
              ...
              ?>
              <li> <a  href="movimentacoes.php?pagina=<?php echo $i-1; ?>"> <?php echo $i; ?> </a></li>
    
          <?php } } }?>

          <li><span class="ls-gap">...</span></li>
          <li><a href="movimentacoes.php?pagina=<?php echo $proximo; ?>">Próximo &raquo;</a></li>
        </ul>
      </div>
