  ...
  <div class="ls-sidebar-inner">
    ...
    <main class="ls-main ">
      <div class="container-fluid"><br>
        <h2 align="justify" style="color: #FF7F00;" align="center"> Histórico das Movimentações Abril/2019</h2><br>
...
<?php  
      ...
      $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE DATA_VENCIMENTO
          BETWEEN '2019-04-01' AND '2019-04-30' AND LANCAMENTO = 'Receita' AND idUSUARIO = '$id_usuario' ";
       $total = mysqli_query($conexao, $query);
          ...
          if ($soma_receita < 0){
           ...
           $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE DATA_VENCIMENTO
          BETWEEN '2019-04-01' AND '2019-04-30' AND LANCAMENTO = 'Despeza' AND idUSUARIO = '$id_usuario' ";
          $total = mysqli_query($conexao, $query);
...
<div align="center">
   ...
   <a href="#" id="info" class="ls-btn-dark ls-color " data-ls-module="popover" data-title="Informações" 
   data-content="<p><b> Valor Total das despezas: &nbsp; </b> <?php echo $soma_despeza ?> R$.</p> <br>
...
<!-- ########################################################################################################## -->
        ...
        <div>       
              ...
              <?php  
                ...
                $query = "SELECT * FROM movimentacoes WHERE DATA_VENCIMENTO BETWEEN '2019-04-01' AND '2019-04-30' AND idUSUARIO = '$id_usuario' AND DESCRICAO LIKE '%".$palavra."%'  ORDER By DATA_PAGAMENTO DESC LIMIT $inicio, $itens_por_pagina";
