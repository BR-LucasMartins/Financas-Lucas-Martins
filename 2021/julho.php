  ...
  <div class="ls-sidebar-inner">
    ...
    <main class="ls-main ">
      <div class="container-fluid"><br>
        <h2 align="justify" style="color: #FF7F00;" align="center"> Histórico das Movimentações Julho/2021</h2><br>
...
<?php  
      ...
      $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE DATA_VENCIMENTO
          BETWEEN '2021-07-01' AND '2021-07-31' AND LANCAMENTO = 'Receita' AND idUSUARIO = '$id_usuario' ";
       $total = mysqli_query($conexao, $query);
          ...
          if ($soma_receita < 0){
           ...
           $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE DATA_VENCIMENTO
          BETWEEN '2021-07-01' AND '2021-07-31' AND LANCAMENTO = 'Despeza' AND idUSUARIO = '$id_usuario' ";
          $total = mysqli_query($conexao, $query);
...
<!-- ########################################################################################################## -->
        ...
        <div>       
              ...
              <?php  
                ...
                $query = "SELECT * FROM movimentacoes WHERE DATA_VENCIMENTO BETWEEN '2021-07-01' AND '2021-07-31' AND idUSUARIO = '$id_usuario' AND DESCRICAO LIKE '%".$palavra."%'  ORDER By idFINANCAS DESC LIMIT $inicio, $itens_por_pagina";
        ...
        <ul class="ls-pagination">
          <li>
              <?php 
                if($anterior >= 0)
                { ?>
                  <a href="julho.php?pagina=<?php echo $anterior; ?>">&laquo; Anterior</a></li>  
                <?php 
                }
          ...
          <?php  
            for($i=$inicio; $i<= $limite; $i++){  
              ...
              ?>
              <li> <a  href="julho.php?pagina=<?php echo $i-1; ?>"> <?php echo $i; ?> </a></li>
    
          <?php } } }?>

          <li><span class="ls-gap">...</span></li>
          <li><a href="julho.php?pagina=<?php echo $proximo; ?>">Próximo &raquo;</a></li>
        </ul>
      </div>
