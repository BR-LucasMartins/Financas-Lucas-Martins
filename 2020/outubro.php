  ...
  <div class="ls-sidebar-inner">
    ...
    <main class="ls-main ">
      <div class="container-fluid"><br>
        <h2 align="justify" style="color: #FF7F00;" align="center"> Histórico das Movimentações Outubro/2020</h2><br>
...
<?php  
      ...
      $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE DATA_VENCIMENTO
          BETWEEN '2020-10-01' AND '2020-10-31' AND LANCAMENTO = 'Receita' AND idUSUARIO = '$id_usuario' ";
       $total = mysqli_query($conexao, $query);
          ...
          if ($soma_receita < 0){
           ...
           $query = "SELECT SUM(VALOR) as total FROM movimentacoes WHERE DATA_VENCIMENTO
          BETWEEN '2020-10-01' AND '2020-10-31' AND LANCAMENTO = 'Despeza' AND idUSUARIO = '$id_usuario' ";
          $total = mysqli_query($conexao, $query);
...
<!-- ########################################################################################################## -->
        ...
        <div>       
              ...
              <?php  
                ...
                $query = "SELECT * FROM movimentacoes WHERE DATA_VENCIMENTO BETWEEN '2020-10-01' AND '2020-10-31' AND idUSUARIO = '$id_usuario' AND DESCRICAO LIKE '%".$palavra."%'  ORDER By idFINANCAS DESC LIMIT $inicio, $itens_por_pagina";
