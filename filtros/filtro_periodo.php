...
$data3 = implode("/",array_reverse(explode("-",$data_pg)));
$data4= implode("/",array_reverse(explode("-",$data_vc)));
  ...
  <div class="ls-sidebar-inner">
    ...
    <main class="ls-main ">
      <div class="container-fluid">
        ...
        <p >Contas Com vencimento entre <span class="ls-color-info"> <?php echo$data3; ?> </span> e 
        	<span class="ls-color-info"> <?php echo $data4;?> </span> </p>
...
<!-- ########################################################################################################## -->
        ...
        <div>       
              ...
              <?php  
                ...
                BETWEEN ('$data_pg') AND ('$data_vc')  ORDER By idFINANCAS DESC";
